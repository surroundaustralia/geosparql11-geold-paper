...
Here we discuss the motivations behind updating GeoSPARQL 1.0 in \Cref{sec:motivation}, content of the planned GeoSPARQL 1.1 release in \Cref{sec:newfeatures} and finally in \Cref{sec:conclusions} provide an outlook to further feature requests which are likely to be tackled in future GeoSPARQL 1.2 and 2.0 releases.
...
\begin{enumerate}
    \item \textbf{GeoJSON} (Geo-JavaScript Object Notation)\footnote{\url{https://geojson.org}}%\cite{butler2016geojson}
    \item \textbf{KML} (Keyhole Markup Language)%\footnote{\url{http://doi.org/10.1007/978-1-4614-7900-0\_17}}%~\cite{nolan2014keyhole} 
